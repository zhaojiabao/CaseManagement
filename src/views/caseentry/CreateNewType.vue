					...
					<div style="height: 500px;overflow: auto;">
						<div class="clear-float" style="height: 230px;margin-top: 15px;" v-for="(item,index) in resData" :key='index'>
							<div style="width: 30px;float: left;text-align: center;height: 200px;line-height: 200px;">
								<input type="checkbox" name="checkbox" id="checkbox" :disabled="userId==item.userId" :value='item.id' />
							</div>
							<div style="width: 710px;float: left;height: 240px;border: 1px solid #eee;border-radius: 4px;">
								<div style="width: 100%;text-align: center;height: 40px;line-height: 40px;font-weight: bold;">
									对象类型：{{item.object_name}}
								</div>
								<div class="clear-float">
									<div style="float: left;width: 230px;height: 190px;border: 1px solid #eee;border-radius: 4px;margin-left: 5px;overflow: auto;">
												...
												<div style="float: left;width:500px;">
													<div style=" position: relative;height: 8px;margin-top: 45px;width: 100%;background: url(http://dphp.yysoul.com/img/toright.png);background-size: 100% 100%;position: relative;">
														<div :style="'height: 8px;width: 8px;border-radius: 4px;background: rgba(0,0,0,0.7);position: absolute;top: 0px;box-shadow: 0 0 10px #FFFFFF;left:' +100/ele.ele_content.length*threeindex+'%;'" :key='threeindex' v-for="(three,threeindex) in ele.ele_content" :class="{changeBack:three.selectvalue}" @click="clickObjectDot(item,three)">
															<div  :title="three.ele_protery_desc" style="position: absolute; top: -45px;left: -95px;width: 200px;text-align: center;" v-if='three.selectvalue'>
